...
suite('Component3', () => {
  ...
  suite('Default', () => {
    setup(async () => {
      el = await fixture(html` <component-3>light-dom</component-3> `);
      await el.updateComplete;
    });

    test('has a default heading "Hey there Component 3" and counter 5', () => {
      assert.equal(el.heading, 'Hey there Component 3');
  ...
  suite('Events ', () => {
    setup(async () => {
      el = await fixture(html` <component-3></component-3> `);
      await el.updateComplete;
    });
  ...
  suite('Override ', () => {
    setup(async () => {
      el = await fixture(html` <component-3 heading="attribute heading"></component-3> `);
      await el.updateComplete;
    });
