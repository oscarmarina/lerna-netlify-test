...
*/
var ComponentB = class extends LitElement {
	constructor(..._args) {
		super(..._args);
		this.heading = "Hey there B";
		this.counter = 5;
	}
	static {
		this.styles = [styles];
...
__decorate([property({ type: String })], ComponentB.prototype, "heading", void 0);
__decorate([property({ type: Number })], ComponentB.prototype, "counter", void 0);
//#endregion
export { ComponentB as t };
